...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      id="nav-section"
    >
      <a href="/" id="left" className="cursor-pointer text-3xl md:text-4xl">
        {/* framemotion? code */}
        ...
        />
        <ul
          className={`fixed text-slate-700 h-screen font-bold md:static md:h-16 ${
            togglemobile ? "translate-x-0" : "translate-x-full md:translate-x-0"
          } bottom-0 right-0 top-0 flex w-36 flex-col items-center justify-start gap-5 border-l-2 bg-white px-2 pt-16 duration-500 md:w-full md:flex-row md:justify-normal md:border-0 md:bg-white md:pt-1`}
        >
          <li className="cursor-pointer font-normal text-sm  hover:text-purple-500">
            <Searchbar/>
          </li>
          <li
