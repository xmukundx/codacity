...
const Test = () => {
  const showModal = () => {
    document.getElementById("dialogComponent").showModal();
  };
  ...
  return (
    <div className="grid grid-rows-1 grid-cols-5 bg-lime-100">
      <aside className=" hidden sm:block bg-red-500flexAdjustBtn text-sm  border border-black py-1 px-3">
        <h1>All courses</h1>
        <Dialog/>
        <h1 onClick={showModal} className="flexAdjustBtn  border  border-black py-1 px-3 w-fit border-r bg-white ">
          <RiFilter2Fill />
          Filter
        </h1>
        <ul>
      ...
      <div className=" col-span-5 sm:col-span-4 w-full">
        ...
        <div className="flex sm:hidden justify-around my-3">
          <button className="flexAdjustBtn  border bg-gray-100 border-black py-1 px-1 active:bg-purple-500 active:text-white w-24 rounded-md ">
